...
Definition d (n : nat) : R := 7.

Definition E (x : R) : Prop := exists n : nat, d n = x.
...
Lemma is_upper_bound_d_7 : is_upper_bound E 7.
Proof.
  unfold is_upper_bound. intros x H. unfold E in H. destruct H as [n H].
  unfold d in H. rewrite H. lra. 
Qed.

Lemma is_least_upper_bound_d_7 : is_lub E 7.
Proof.
  unfold is_lub. split.
  - apply is_upper_bound_d_7.
  - intros b. unfold is_upper_bound. intros H. unfold E in H. apply H.
